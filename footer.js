...
(function() {
  var footerHTML = '' +
    ...
    '<div class="footer-bottom">&copy; 2026 NRI Bridge India. All rights reserved. Registered in India.' +
      '<span class="footer-credits" style="display:block;margin-top:6px;">Made by <a href="https://github.com/CatOn60Hz" target="_blank" rel="noopener" style="color:var(--accent-soft);text-decoration:none;">CatOn60Hz</a> &amp; <a href="https://github.com/Asar007" target="_blank" rel="noopener" style="color:var(--accent-soft);text-decoration:none;">Asar007</a></span>' +
    '</div>';
