...
(function() {
  // Determine current page for active state (works with both clean URLs and .html paths)
  var path = window.location.pathname;
  var currentPage = path === '/' ? '' : path.replace(/^\//, '').replace(/\.html$/, '');
  var isServicesPage = ['home-management','vehicle-management','parental-care','legal-documentation','services'].indexOf(currentPage) !== -1;
  ...
  var navHTML = '' +
    '<div class="nav-logo"><a href="/"><img src="NRI-BRIDGE-INDIA_LOGO-WHITE-PNG.png" alt="NRI Bridge India" style="height:80px;width:auto;display:block;"></a></div>' +
    '<ul class="nav-links">' +
      '<li><a href="/"' + activeClass('') + '>Home</a></li>' +
      '<li class="nav-dropdown">' +
        '<a href="/services"' + (isServicesPage || isServiceDetail ? ' class="active"' : '') + '>Services <span class="nav-arrow">&#9662;</span></a>' +
  ...
  function renderLoggedIn(name, email, role) {
    ...
    var adminLink = isAdmin
      ? '<a href="/admin"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> Admin Portal</a>'
      : '';

    var menuItems;
    if (isEmployee) {
      menuItems =
        '<a href="/employee"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg> My Work</a>';
    } else {
      menuItems =
        '<a href="/dashboard"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg> Dashboard</a>' +
        '<a href="/onboarding"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg> Manage Services</a>';
    }

    // Hide "Request Service" links for employees
    if (isEmployee) {
      document.querySelectorAll('.nav-links a[href="/services"], .nav-links a[href^="/home-management"], .nav-links a[href^="/vehicle-management"], .nav-links a[href^="/parental-care"], .nav-links a[href^="/legal-documentation"]').forEach(function(el) {
    ...
    navActions.innerHTML =
      '<div class="nav-user-dropdown" id="navUserDropdown">' +
        ...
        '<div class="nav-user-menu" id="navUserMenu">' +
          menuItems +
          adminLink +
          '<a href="/edit-profile"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> Edit Profile</a>' +
